...
private val LightColorPalette = PdcColors(
    brand = Shadow5,
    brandSecondary = Ocean3,
    uiBackground = Neutral3,
    uiBorder = Neutral4,
...
private val DarkColorPalette = PdcColors(
    brand = Shadow1,
...
fun PacoteDeCarinhoTheme(
    ...
    ProvidePdcColors(colors = colors) {
        MaterialTheme(
...
object PacoteDeCarinhoTheme{
    val colors: PdcColors
    @Composable
    get() = LocalPdcColors.current
}
...
fun ProvidePdcColors(
    ...
    CompositionLocalProvider(LocalPdcColors provides colorPalette, content = content)
}

private val LocalPdcColors = staticCompositionLocalOf<PdcColors> {
    error("No PdcColorPalette provided")
}
